      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="{{ route('movies.show', $movie->id) }}">Show</a> | <a href="{{ route('movies.edit', $movie->id) }}">Edit</a> | <a href="{{ route('movies.destroy', $movie->id) }}" data-method="delete">Delete</a></td>
          </tr>
          @endforeach
        </tbody>
      </table>
